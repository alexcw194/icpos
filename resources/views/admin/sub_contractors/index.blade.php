...
<div class="page-header d-print-none">
  <div class="container-xl d-flex align-items-center">
    <h2 class="page-title">Master Data - Sub-Contractors</h2>
    <a href="{{ route('sub-contractors.create') }}" class="btn btn-primary ms-auto">Tambah</a>
  </div>
</div>
...
<div class="page-body">
  <div class="container-xl">
    ...
    <form class="mb-3" method="get" action="{{ route('sub-contractors.index') }}">
      <div class="row g-2">
        <div class="col-md-6">
            ...
            @forelse($rows as $i => $row)
              <tr>
                ...
                <td class="text-nowrap">
                  <a href="{{ route('sub-contractors.edit', $row) }}" class="btn btn-sm">Edit</a>
                  <form action="{{ route('sub-contractors.destroy', $row) }}" method="post" class="d-inline" onsubmit="return confirm('Hapus sub-contractor ini?')">
                    @csrf @method('DELETE')
