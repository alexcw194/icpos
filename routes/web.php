...
use App\Http\Controllers\Report\FamilyReportController;
...
Route::get('project-items/{item}', [ItemController::class, 'show'])
    ...
    Route::delete('/inventory/adjustments/{adjustment}', [\App\Http\Controllers\StockAdjustmentController::class, 'destroy'])
...
Route::middleware(['auth', EnsureAdmin::class])->group(function () {
    ...
    Route::redirect('reports/apar', '/reports/family')
        ->name('reports.apar');
